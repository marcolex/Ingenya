...
namespace Ingenya
{
    public partial class Form2 : MaterialSkin.Controls.MaterialForm
    {
        ...
        public Form2(ProyectoRoom proyectoRoom, string Proyecto, string Room)
        {
        ...
        private void Txt_RAHWBT_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                RAHWBT = double.Parse(txt_RAHElevation.Text);
        ...
        private void Txt_SeatedP_TextChanged(object sender, EventArgs e)
        {
